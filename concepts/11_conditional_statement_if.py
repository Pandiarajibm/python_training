...
# it gives list of keys in list datatype - list of keys in strings datatype

# >>> my_dictionary.values()
# ['python', 'online']
# it gives list of values in list datatype - square bracket -list of values in strings datatype
if "python" in my_dictionary.values():
    print("Value 'python' found")

# >>> my_dictionary.items()
# [('course', 'python'), ('mode', 'online')]
# it gives list of key and values in tuple datatype in parenthesis bracket ie list of tuples
