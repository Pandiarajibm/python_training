"""
for-loop: Iterate any collection wherever we keep multiple values
"""
...
# No need to define or declare variable in python
# we can give meaningful name say each_employee or we i, j, k . no need to define it.
# if we refer variable each_employee to list, it will work as list.
# if it is referred to dictionary then it will become dictionary

for each_employee in employees_list:
    print("Employee", each_employee)
...
# No need to define or declare variable in python
# we can give meaningful name  or we can use i, j, k . no need to define variable.
# if we refer variable each_employee to list, it will work as list.
# if it is referred to dictionary then it will become dictionary

for k in my_dictionary: # Iterate key . key will be used to iterate by default
    print("Key:", k)
...
# range(1,5) # produce the 1 to 4
# range(2,5) # produce the 2 to 4
# range(2,5,2) # produce the 2, 4 # Step by
...
for j in range(1, 10, 2):  # produce the 1, 3, 5, 7, 9
    print(j)
