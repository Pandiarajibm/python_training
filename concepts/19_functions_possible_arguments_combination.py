...
# Before * argument, all are considered as POSITIONAL arguments, it is mandatory argument.
#    a,b,d, e in below 2 functions are mandatory argument which must be provided
# After * argument, all are considered as keyword argument.
#   There can be zero or more values after*
# Always, last argument will be variable keyword argument
#    After ** there can be zero or more values.
...
my_function(10, 20, d=30, e=40) # With minimal values - I did not mention c and f.
my_function(10, 20, 30, 40, 50, d=60, e=70, x=100, y=200, z=300)
    #provided all values in the above function
print("#"*40, end="\n\n")
#########################
...
# by putting * , i am making c and d as mandatorily keyword arguments
def my_function(a, b, /, *, c, d):
    print("Value of a is:", a)
    print("Value of b:", b)
    print("Value of c:", c)
...
my_own_print_function() # we are not passing any thing. it will be empty.it wont print anything.
my_own_print_function(10, 20, 30, "HEllo", "Python", "Java")
my_own_print_function(10, 20, 30, "HEllo", "Python", "Java", sep="\t\t\t", end="\n\n")
my_own_print_function(10, 20, 30, "HEllo", "Python", "Java", sep="\t\t\t", end="PandiaXYZ\n")
my_own_print_function(10, 20, 30, "HEllo", "Python", "Java", sep="\t\t\t", end="PandiaXYZ\n\n")
print("#"*40, end="\n\n")
#########################
