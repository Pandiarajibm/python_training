...
# This WILL NOT WORK . We cannot pass argument name as below. So It will fail
# received_value = employee_function(name="emp-2", company="comp-2")
# print("received_value:", received_value)
...
# # This WILL NOT WORK as we are not passing arguments
# received_value = employee_function("emp-1", "comp-1")
# print("received_value:", received_value)
...
print("Some example" 'Getting value from somewhere say db or json,etc and then passing them'
      'to employee_function as variables x and y')
print("-"*20)
# ----------------
...
# if we want to make a variable, function, class , file as Private, then we use
# _ underscore before the variable/function/class.
# prefix underscore _variable
# def _function1
# _x= 49
# _filenam
# -myClass

# in other language, we have private, public etc. - these are only needed for developers and not
# for users. So why to learn new concept for developer's sake.
# SoIn Python there is no retriction to block private . just by mentioning _, we informing
# developer that it is private and dont use it.

# system defined functions also we have _ for builtin functions
