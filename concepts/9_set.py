...
# Difference between update function and union function as both seems doing same work. Union will update the combined values
# to new variable - say as new set ie all_customers. update will update with existing set.
